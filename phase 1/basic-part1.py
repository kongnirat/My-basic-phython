...
#ลำดับแรกคือ () โดยโปรแกรมจะทำงานจากซ้ายไปขวา
#ลำดับสองคือ +,++,-,--(size,type) โดยโปรแกรมจะทำงานจากขวาไปซ้าย
#ลำดับสามคือ *,/,% โดยโปรแกรมจะทำงานจากซ้ายไปขวา
#ลำดับสี่คือ + or - โดยโปรแกรมจะทำงานจากซ้ายไปขวา
#ลำดับสุดท้ายคือ = โดยโปรแกรมจะทำงานจากขวาไปซ้าย
#กรณีตัวอย่าง
v = (5+4)*(4/2)-8 #จากกรณิตัวอย่างโปรแกรมจะทำงานจากซ้ายไปขวาโดยจะเริ่มจาก (5+4) แล้วจึงไปทำงานที่ (4/2) และตามลำดับก็จะนำผลลัพพ์ทั้งสองมาคูณกัน แล้วสุดท้ายก็นำไปลบจึงจะได้คำตอบ
